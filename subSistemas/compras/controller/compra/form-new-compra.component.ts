...
declare var $: any;
@Component({
        selector: 'form-new-compra',
        templateUrl: '../../view/compra/form-new-compra.component.html',
...
export class FormNewCompraComponent extends ControllerComponent implements AfterViewInit {

        autocompletadoSerieActivado:boolean=true;
        ...
        tituloPanel:string="Registro de Compras";
        ...
        obtenerUltimoTC(){
                this.tipoCambioService.getAllLatest().subscribe(
                        data=>{
                                ...
                                this.tipoCambioSelected = (this.ExchangeRate[0].precio_venta/2+ this.ExchangeRate[0].precio_compra/2).toFixed(2);              
                })
        }
        ...
        autocompletarCerosSerie(event: any) {
                this.print("autocompletadoSerieActivado: "+this.autocompletadoSerieActivado);
                if(this.autocompletadoSerieActivado){
        ...
        autocompletarCerosNumero2(event: any) {
                ...
                if (this.numeroGuiaSelected != null) {
                        if (this.numeroGuiaSelected != "") {
                                let numero = this.completarCerosIzquierda(8, "" + parseInt(this.numeroGuiaSelected));
                                this.numeroGuiaSelected = numero;
                        }
                }
        ...
        setBeanEditar(obj) {
                ...
                this.beanSelectedExterno = obj;
                this.idCompraSelected=obj.id_compra;
                        ...
                        this.compraService.getCompraById(obj.id_compra)
                                .subscribe(
                                        data => {
                                                ...
                                                if (data.guiaRemision != null) {
                                                        if (data.guiaRemision.length == 1) {
                                                                let guia = data.guiaRemision[0];

                                                                this.id_guia_remision = guia.id_guia_remision;
                                                                this.numeroGuiaSelected = guia.numero;
                                                                this.serieGuiaSelected = guia.serie;
                                                               
                                                               if(guia.fecha_emision == null){
                                                               this.print("no hay fecha de emision");
                                                               this.fechaEmisionSelected = guia.fecha_emision;
                                                                this.fechaInicioTrasladoSelected = guia.fecha_inicio_traslado;
                                                               }else{
                                                                this.fechaEmisionSelected = guia.fecha_emision.substr(0, 10);
                                                                this.fechaInicioTrasladoSelected = guia.fecha_inicio_traslado.substr(0, 10);
                                                               }
                                                ...
                                                if (data.comprobante != null) {
                                                        ...
                                                        this.id_comprobante = comprobante.id_comprobante;
                                                        this.serieComprobanteSelected = comprobante.serie;
                                                        this.numeroComprobanteSelected = comprobante.numero;
                                                        this.fechaComprobanteSelected = comprobante.fecha.substr(0, 10);
                                                        this.tipoComprobanteSelected = this.obtenerTipoComprobanteActual(comprobante.nombre_tipo_com);
                                                ...
                                                this.percepcionSelected=this.compraSelected.percepcion;
                                                this.retencionSelected=this.compraSelected.retencion;
                                                this.detraccionSelected=this.compraSelected.detraccion;
                                                this.diasCreditoSelected=this.compraSelected.dias_credito;

                                                this.montoTotalSelected = this.compraSelected.monto_total;
                                                this.tipoCompraSelected = this.obtenerTipoCompraActual(this.compraSelected.id_tipo_compra);
                                                /*this.print("compra: ");
                                                this.print(this.compraSelected);*/
                                                this.medioPagoSelected = this.obtenerMedioPagoActualNombre(this.compraSelected.medio_pago);
                                                ...
                                                for(let i=0;i<this.listaProductos.length;i++){
                                                        this.listaProductos[i].nuevo=true; 
                                                }
        ...
        limpiarCampos() {
                ...
                this.almacenes=null;
                //this.locales =null;
               // this.tiposCompra = null;
                this.fechaSelected=null;
                this.percepcionSelected=null;
                this.detraccionSelected=null;
                this.retencionSelected=null;
                this.medioPagoSelected=null;
               // this.tipoCambioSelected=null;
                ...
                this.estadoSelected = "";
                this.tituloPanel="Registro de Compras";
        ...
        abrirModalProveedor() {
                this.abrirModal("modalProveedorNewCompra");
        ...
        calcularPrecioIgv() {
                ...
                if (this.incluyeIgvSelected == true) {
                        ...
                        for (let i = 0; i < this.listaProductos.length; i++) {
                                ...
                                this.listaProductos[i].precio_venta = this.listaProductos[i].precio;
                ...
                if (this.incluyeIgvSelected == false) {
                        ...
                        for (let i = 0; i < this.listaProductos.length; i++) {
                                ...
                                this.listaProductos[i].precio_venta = this.listaProductos[i].precio_igv;
                        }
                }
        }
        ...
        calcularPorcDescTotal(i: any) {
                ...
                this.listaProductos[i].precio_desc=this.listaProductos[i].precio;
        ...
        obtenerProveedorDatosExternos(datos) {
                ...
                this.print(datos);
                this.cerrarModal("modalProveedorNewCompra");


        }


        activarAutocompletadoElectronica(){

                this.print("tipo comprobante: ");
                this.print(this.tipoComprobanteSelected);
                if(this.tipoComprobanteSelected.nombre=="FACTURA ELECTRONICA" || this.tipoComprobanteSelected.nombre=="BOLETA ELECTRONICA"){
                        this.autocompletadoSerieActivado=false;
                }else{
                        this.autocompletadoSerieActivado=true;
                }
        }
...
/*
        ...
        elegirProducto(producto: any, indice: any) {
                if (producto != null) {
                        this.print("productos de compra");
                        this.print(producto);
                        this.indiceLista = -1;
                        ...
                        this.listaProductos[indice].precio_referencia = producto.precio_referencia;
