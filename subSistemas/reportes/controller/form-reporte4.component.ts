...
declare var $: any;
@Component({
        selector: 'form-reporte4',
        templateUrl: '../view/form-reporte4.component.html',
        providers: [ReportePdfService,ReporteExcelService]

})

export class FormReporte4Component extends ControllerComponent implements AfterViewInit {
