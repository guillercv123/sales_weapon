...
export class CargoService extends Service {
        ...
        getAll() {
                ...
                return this.http.get(this.rutasMantenedores.API_CARGO_REST, options)
                        .pipe(map(
                        data => {
                                this.print("response:");
        ...
        registrar(parametros: any) {
                ...
                return this.http.post(this.rutasMantenedores.API_CARGO_REST, parametros, options)
                        .pipe(map(
                        data => {
        ...
        editar(parametros: any, id:any) {
                ...
                let options = this.getOptionsToken();
                return this.http.put(this.rutasMantenedores.API_CARGO_REST+ "/id_cargo/" + id + "/", parametros, options)
                        .pipe(map(
                        data => {
        ...
        eliminarLogico(id: string) {
                ...
                return this.http.delete(this.rutasMantenedores.API_CARGO_REST + "/id_aplicacion/" + id + "/", options)
                        .pipe(map(
                        data => {
                                if (!this.tokenInvalido(data.json())) {
                                        let res = data.json();
        ...
        buscarPaginacion( inicio: any, fin: any, tamPagina: any,parametros: any) {
                ...
                this.print("ruta: "+this.rutasMantenedores.API_CARGO_REST + "/inicio/" + inicio + "/fin/" + fin + "/tamPagina/" + tamPagina + "/");

                this.print("parametros : " +parametros);
               
                return this.http.post(this.rutasMantenedores.API_CARGO_REST + "/inicio/" + inicio + "/fin/" + fin + "/tamPagina/" + tamPagina + "/",parametros, options)
                        .pipe(map(
                                data => {
                                        this.print("response:");
                                        this.print(data.json());
        ...
        getTotalParametros(parametros:any) {
                ...
                let options = this.getOptions();
                return this.http.post(this.rutasMantenedores.API_CARGO_REST + "/total/", parametros,options)
                        .pipe(map(
