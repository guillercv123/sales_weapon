...
@Injectable()
export class AsignacionPlazaService extends Service {
        ...
        editar(parametros: any, id:any) {
                ...
                let options = this.getOptionsToken();
                return this.http.put(this.rutasMantenedores.API_EMPRESA_REST+ "/id_aplicacion/" + id + "/", parametros, options)
                        .pipe(map(
                        data => {
        ...
        eliminarLogico(id: string) {
                ...
                return this.http.delete(this.rutasMantenedores.API_EMPRESA_REST + "/id_aplicacion/" + id + "/", options)
                        .pipe(map(
                        data => {
                                if (!this.tokenInvalido(data.json())) {
                                        let res = data.json();
