...
@Injectable()
export class PorcentajeService extends Service {
        ...
        getAll() {
                ...
                return this.http.get(this.rutasMantenedores.API_PORCENTAJE_REST, options)
                        .pipe(map(
                        data => {
                                this.print("response:");
        ...
        editar(parametros: any) {

                let options = this.getOptionsToken();
                return this.http.put(this.rutasMantenedores.API_PORCENTAJE_REST+ "/id_porcentaje", parametros, options)
                        .pipe(map(
                        data => {
