...
declare var $: any;
@Component({
        selector: 'form-find-caja',
        templateUrl: '../../view/caja/form-find-caja.component.html',
        providers: [ProductoService,ClienteService, MedioPagoService, VentaService, ReportePdfService, ReporteExcelService,
                LocalService]

})

export class FormFindCajaComponent extends ControllerComponent implements AfterViewInit {
        ...
        @Output() pagarVentaAction = new EventEmitter();
        ...
        obtenerVentasPorPagar() {
                this.limpiarCampos();
                //this.getTotalLista();
                this.buscarVentasPorPagar(this.inicio, this.fin, this.tamPagina);
        }
        ...
        seleccionarByPagina(inicio: any, fin: any, tamPagina: any) {
                ...
                this.ventaService.buscarPaginacion(inicio, fin, tamPagina, parametros,id)
                        .subscribe(
                                data => {
                                        if(data == null){
                                                this.mensajeAdvertencia("VENTA NO GENERADA O YA ESTA PAGADA");
                                        }else{
                                              this.ventas = data;    
                                        }
        ...
        seleccionarByPaginaxStandby(inicio: any, fin: any, tamPagina: any,parametro:number) {
        ...
        buscarVentasPorPagar(inicio: any, fin: any, tamPagina: any) {
                let parametros = JSON.stringify({
                        id_venta: this.id_venta_busqueda,
                        id_cliente: this.clienteSelected == null ? null : this.clienteSelected.id_cliente,
                        estado: this.estadoSelected,
                ...
                let user = this.obtenerUsuario();
                this.ventaService.buscarVentasPorPagar(parametros)
                        .subscribe(
                                data => {
                                        this.ventas = data;
                                        this.print(data);
        ...
        buscar() {
                if (this.tienePermisoPrintMsj(this.rutas.FORM_CAJA, this.rutas.BUTTON_BUSCAR)) {
                        this.getTotalLista();
                        this.seleccionarByPagina(this.inicio, this.fin, this.tamPagina);
                }
        }
        ...
        verVentasEnStandBy(){
                ...
                this.ventaService.getUltimasVentas(parametros,id)
                        .subscribe(
                                data => {
                                        if(!data){
                                                this.mensajeAdvertencia("No tienes ventas en espera");
                                        }else{
        ...
        seleccionar(pro){
                ...
                this.seleccionarByPaginaxStandby(this.inicio, this.fin, this.tamPagina,pro.id_venta);
                this.cerrarModal("VentaStandBy");
        }
        ...
        eliminar(bean) {
                ...
                if (this.tienePermisoPrintMsj(this.rutas.FORM_CAJA, this.rutas.BUTTON_ELIMINAR)) {
        ...
        pagarComprobante(bean) {
                if (this.tienePermisoPrintMsj(this.rutas.FORM_COMPRA, this.rutas.PANEL_EDITAR)) {
                        this.pagarVentaAction.emit({ bean: bean });
                        this.print("datos de comprobante a pagar");
                        this.print(bean);
