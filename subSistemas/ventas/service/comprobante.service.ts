...
@Injectable()
export class ComprobanteService extends Service {
        ...
        buscarPaginacion(inicio: any, fin: any, tamPagina: any, parametros: any) {
                ...
                let options = this.getOptions();
                this.print("ruta: " + this.rutasVentas.API_COMPROBANTE_REST + "/inicio/" + inicio + "/fin/" + fin + "/tamPagina/" + tamPagina + "/");
                ...
                return this.http.post(this.rutasVentas.API_COMPROBANTE_REST + "/inicio/" + inicio + "/fin/" + fin + "/tamPagina/" + tamPagina + "/", parametros, options)
                        .pipe(map(
                        data => {
                                this.print("response:");
                                this.print(data.json());
        ...
        eliminarLogico(id: string) {
                ...
                return this.http.delete(this.rutasVentas.API_COMPROBANTE_REST + "/id_comprobante/" + id + "/", options)
                        .pipe(map(
                        data => {
                                if (!this.tokenInvalido(data.json())) {
                                        let res = data.json();
        ...
        getTotalParametros(parametros: any) {
                ...
                let options = this.getOptions();
                return this.http.post(this.rutasVentas.API_COMPROBANTE_REST + "/total/", parametros, options)
                        .pipe(map(
                        /************FILTRAR LA DATA QUE SE QUIERE ENVIAR**************** */
                        data => {
                                if (!this.tokenInvalido(data.json())) {
